...
//  printf("************** DROP EVENT ***********\n"); fflush(stdout);
  ...
  ThreadedModFileCount *counter = new ThreadedModFileCount(droppedFiles);
  ...
  connect(counterThread, &QThread::started, counter, &ThreadedModFileCount::run);



  connect(counter, &ThreadedModFileCount::countingFiles, this, [=](int filesCounted) {
  ...
  connect(counter, &ThreadedModFileCount::filesCounted, this, [=, this](QJsonArray *allFiles) {
