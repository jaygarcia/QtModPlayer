...
#define PACKAGE_STRING "libopenmpt 0.3.9+release.autotools"
...
#define PACKAGE_VERSION "0.3.9+release.autotools"

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Version number of package */
#define VERSION "0.3.9+release.autotools"
